package cn.ccrise.baseframe.widget;
...
public class SwipeBackLayout extends FrameLayout {
	...
	public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mShadowDrawable = getResources().getDrawable(cn.ccrise.baseframe.R.drawable.shadow_left, context.getTheme());
        }else{
            mShadowDrawable = getResources().getDrawable(cn.ccrise.baseframe.R.drawable.shadow_left);
        }
	}
